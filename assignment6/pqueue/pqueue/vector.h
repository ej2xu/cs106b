 ...
 *
 * This special version of Vector adds the bytesUsed member function
 * to retrieve the storage in use by a Vector, needed in the testing
 * trials for the PQ assignment.
 */
...
template <typename ElemType> 
  class Vector {
	...
	public:
		 ...
		 * Usage: int nBytes = vec.bytesUsed();
		 * ------------------------------------
		 * This member function returns the total number of bytes currently
		 * in use by this pqueue.
		 */	
		int bytesUsed();
